...
enum Artifact
{
    ...
    // Necklace
    Celestial_Necklace_of_Bliss, Necklace_of_Swiftness, Pendant_of_Courage,

    // Weapon
    Sword_of_Judgement, Angelic_Alliance, Centaurs_Axe, Red_Dragon_Flame_Tongue, Blackshard_of_the_Dead_Knight, Armageddons_Blade, Greater_Gnolls_Flail, Ogres_Club_of_Havoc, Sword_of_Hellfire, Trident_of_Dominion, Titans_Gladius,

    // Shield
    Lions_Shield_of_Courage, Dragon_Scale_Shield, Shield_of_the_Dwarven_Lords, Shield_of_the_Yawning_Dead, Buckler_of_the_Gnoll_King, Targ_of_the_Rampaging_Ogre, Shield_of_the_Damned, Shield_of_Naval_Glory, Sentinels_Shield,

    // Armor
    Armor_of_Wonder, Dragon_Scale_Armor, Plate_of_Dying_Light, Breastplate_of_Petrified_Wood, Rib_Cage, Scales_of_the_Greater_Basilisk, Tunic_of_the_Cyclops_King, Breastplate_of_Brimstone, Royal_Armor_of_Nix, Titans_Cuirass,

    // Hand
    Quiet_Eye_of_the_Dragon, Ring_of_Vitality, Ring_of_Life, Ring_of_Wayfarer, Still_Eye_of_the_Dragon, Ring_of_Suppression,

    // Boots
    Sandals_of_the_Saint,

    // Pocket
    Vial_of_Lifeblood, Elixir_of_Life, Badge_of_Courage, Crest_of_Valor, Glyph_of_Gallantry, Hideous_Mask, Pendant_of_Downfall, Spirit_of_Oppression, Cards_of_Prophecy, Clover_of_Fortune, Ladybird_of_Luck, Runes_of_Imminency, Demons_Horseshoe, Shamans_Puppet, Hourglass_of_the_Evil_Hour,
};
...
struct Item
{
    ...
    private:
        ...
        static uint8_t created_items;

    public:
        // Return a pointer to already created Item object.
