...
const std::map<CreatureType, const Creature*>& Creature::create_and_fill_creatures_list()
{
    ...
    static const Creature Pegasus (             CreatureType::Pegasus,             Faction::Rampart,    4, Creature::Upgrade_level::None,    5, true,   9,  8,  0,  5,  9,  30,  8, Morale::Good,    Luck::Neutral,  518,  518, {  250, 0, 0, 0, 0 }, "Flying. Magic damper.");
    static const Creature Silver_Pegasus (      CreatureType::Silver_Pegasus,      Faction::Rampart,    4, Creature::Upgrade_level::First,   5, true,   9, 10,  0,  5,  9,  30, 12, Morale::Good,    Luck::Neutral,  532,  532, {  275, 0, 0, 0, 0 }, "Flying. Magic damper.");
    ...
    static const Creature Green_Dragon (        CreatureType::Green_Dragon,        Faction::Rampart,    7, Creature::Upgrade_level::None,    1, true,  18, 18,  0, 40, 50, 180, 10, Morale::Good,    Luck::Neutral, 3654, 4872, { 2400, 0, 0, 1, 0 }, "Flying. Breath attack. Immune to spells level 1-3.");
    static const Creature Gold_Dragon (         CreatureType::Gold_Dragon,         Faction::Rampart,    7, Creature::Upgrade_level::First,   1, true,  27, 27,  0, 40, 50, 250, 16, Morale::Good,    Luck::Neutral, 6220, 8613, { 4000, 0, 0, 2, 0 }, "Flying. Breath attack. Immune to spells level 1-4.");
    ...
    static const Creature Stone_Gargoyle (      CreatureType::Stone_Gargoyle,      Faction::Tower,      2, Creature::Upgrade_level::None,    9, false,  6,  6,  0,  2,  3,  16,  6, Morale::Good,    Luck::Neutral,  150,  165, {  130, 0, 0, 0, 0 }, "Non-living. Flying.");
    static const Creature Obsidian_Gargoyle (   CreatureType::Obsidian_Gargoyle,   Faction::Tower,      2, Creature::Upgrade_level::First,   9, false,  7,  7,  0,  2,  3,  16,  9, Morale::Good,    Luck::Neutral,  155,  201, {  160, 0, 0, 0, 0 }, "Non-living. Flying.");
    ...
    static const Creature Genie (               CreatureType::Genie,               Faction::Tower,      5, Creature::Upgrade_level::None,    3, false, 12, 12,  0, 13, 16,  40,  7, Morale::Good,    Luck::Neutral,  680,  884, {  550, 0, 0, 0, 0 }, "Flying. Hates Efreeti and Efreet Sultans.");
    static const Creature Master_Genie (        CreatureType::Master_Genie,        Faction::Tower,      5, Creature::Upgrade_level::First,   3, false, 12, 12,  0, 13, 16,  40, 11, Morale::Good,    Luck::Neutral,  748,  942, {  600, 0, 0, 0, 0 }, "Flying. Hates Efreeti and Efreet Sultans. Spellcaster.");
    ...
    static const Creature Efreet (              CreatureType::Efreet,              Faction::Inferno,    6, Creature::Upgrade_level::None,    2, false, 16, 12,  0, 16, 24,  90,  9, Morale::Good,    Luck::Neutral, 1413, 1670, {  900, 0, 0, 0, 0 }, "Flying. Immune to fire spells (Magic Arrow included). Hates Genies and Master Genies.");
    static const Creature Efreet_Sultan (       CreatureType::Efreet_Sultan,       Faction::Inferno,    6, Creature::Upgrade_level::First,   2, false, 16, 14,  0, 16, 24,  90, 13, Morale::Good,    Luck::Neutral, 1802, 2343, { 1100, 0, 0, 0, 0 }, "Flying. Immune to fire spells (Magic Arrow included). Hates Genies and Master Genies. Fire Shield.");
    static const Creature Devil (               CreatureType::Devil,               Faction::Inferno,    7, Creature::Upgrade_level::None,    1, false, 19, 21,  0, 30, 40, 160, 11, Morale::Good,    Luck::Neutral, 3759, 5101, { 2700, 1, 0, 0, 0 }, "Teleporting. -1 luck to enemy troops. No enemy retaliation. Hates Angels and Archangels.");
    static const Creature Arch_Devil (          CreatureType::Arch_Devil,          Faction::Inferno,    7, Creature::Upgrade_level::First,   1, false, 26, 28,  0, 30, 40, 200, 17, Morale::Good,    Luck::Neutral, 5243, 7115, { 4500, 2, 0, 0, 0 }, "Teleporting. -2 luck to enemy troops. No enemy retaliation. Hates Angels and Archangels.");
    ...
    static const Creature Wight (               CreatureType::Wight,               Faction::Necropolis, 3, Creature::Upgrade_level::None,    7, false,  7,  7,  0,  3,  5,  18,  5, Morale::Neutral, Luck::Neutral,  231,  252, {  200, 0, 0, 0, 0 }, "Undead. Flying. Regeneration.");
    static const Creature Wraith (              CreatureType::Wraith,              Faction::Necropolis, 3, Creature::Upgrade_level::First,   7, false,  7,  7,  0,  3,  5,  18,  7, Morale::Neutral, Luck::Neutral,  252,  315, {  230, 0, 0, 0, 0 }, "Undead. Flying. Regeneration. Mana drain.");
    static const Creature Vampire (             CreatureType::Vampire,             Faction::Necropolis, 4, Creature::Upgrade_level::None,    4, false, 10,  9,  0,  5,  8,  30,  6, Morale::Neutral, Luck::Neutral,  518,  555, {  360, 0, 0, 0, 0 }, "Undead. Flying. No enemy retaliation.");
    static const Creature Vampire_Lord (        CreatureType::Vampire_Lord,        Faction::Necropolis, 4, Creature::Upgrade_level::First,   4, false, 10, 10,  0,  5,  8,  40,  9, Morale::Neutral, Luck::Neutral,  652,  783, {  500, 0, 0, 0, 0 }, "Undead. Flying. No enemy retaliation. Life drain.");
    ...
    static const Creature Bone_Dragon (         CreatureType::Bone_Dragon,         Faction::Necropolis, 7, Creature::Upgrade_level::None,    1, true,  17, 15,  0, 25, 50, 150,  9, Morale::Neutral, Luck::Neutral, 2420, 3388, { 1800, 0, 0, 0, 0 }, "Undead. Flying. -1 morale to enemy troops.");
    static const Creature Ghost_Dragon (        CreatureType::Ghost_Dragon,        Faction::Necropolis, 7, Creature::Upgrade_level::First,   1, true,  19, 17,  0, 25, 50, 200, 14, Morale::Neutral, Luck::Neutral, 3228, 4696, { 3000, 1, 0, 0, 0 }, "Undead. Flying. -1 morale to enemy troops. 20% chance to cast Aging per attack.");
    ...
    static const Creature Harpy (               CreatureType::Harpy,               Faction::Dungeon,    2, Creature::Upgrade_level::None,    8, false,  6,  5,  0,  1,  4,  14,  6, Morale::Good,    Luck::Neutral,  140,  154, {  130, 0, 0, 0, 0 }, "Flying. Strike and return.");
    static const Creature Harpy_Hag (           CreatureType::Harpy_Hag,           Faction::Dungeon,    2, Creature::Upgrade_level::First,   8, false,  6,  6,  0,  1,  4,  14,  9, Morale::Good,    Luck::Neutral,  196,  238, {  170, 0, 0, 0, 0 }, "Flying. Strike and return. No enemy retaliation.");
    ...
    static const Creature Manticore (           CreatureType::Manticore,           Faction::Dungeon,    6, Creature::Upgrade_level::None,    2, true,  15, 13,  0, 14, 20,  80,  7, Morale::Good,    Luck::Neutral, 1215, 1547, {  850, 0, 0, 0, 0 }, "Flying.");
    static const Creature Scorpicore (          CreatureType::Scorpicore,          Faction::Dungeon,    6, Creature::Upgrade_level::First,   2, true,  16, 14,  0, 14, 20,  80, 11, Morale::Good,    Luck::Neutral, 1248, 1589, { 1050, 0, 0, 0, 0 }, "Flying. 20% chance to cast Paralyzing Venom per attack.");
    static const Creature Red_Dragon (          CreatureType::Red_Dragon,          Faction::Dungeon,    7, Creature::Upgrade_level::None,    1, true,  19, 19,  0, 40, 50, 180, 11, Morale::Good,    Luck::Neutral, 3762, 4702, { 2500, 0, 1, 0, 0 }, "Flying. Breath attack. Immune to spells level 1-3.");
    static const Creature Black_Dragon (        CreatureType::Black_Dragon,        Faction::Dungeon,    7, Creature::Upgrade_level::First,   1, true,  25, 25,  0, 40, 50, 300, 15, Morale::Good,    Luck::Neutral, 6783, 8721, { 4000, 0, 2, 0, 0 }, "Flying. Breath attack. Immune to all spells. Hates Titans.");
    ...
    static const Creature Roc (                 CreatureType::Roc,                 Faction::Stronghold, 5, Creature::Upgrade_level::None,    3, true,  13, 11,  0, 11, 15,  60,  7, Morale::Good,    Luck::Neutral,  790, 1027, {  600, 0, 0, 0, 0 }, "Flying.");
    static const Creature Thunderbird (         CreatureType::Thunderbird,         Faction::Stronghold, 5, Creature::Upgrade_level::First,   3, true,  13, 11,  0, 11, 15,  60, 11, Morale::Good,    Luck::Neutral,  869, 1106, {  700, 0, 0, 0, 0 }, "Flying. 20% chance to cast Lightning Strike per attack.");
    ...
    static const Creature Serpent_Fly (         CreatureType::Serpent_Fly,         Faction::Fortress,   3, Creature::Upgrade_level::None,    8, false,  7,  9,  0,  2,  5,  20,  9, Morale::Good,    Luck::Neutral,  215,  268, {  220, 0, 0, 0, 0 }, "Flying. Casts Dispel to benefical spells per attack.");
    static const Creature Dragon_Fly (          CreatureType::Dragon_Fly,          Faction::Fortress,   3, Creature::Upgrade_level::First,   8, false,  8, 10,  0,  2,  5,  20, 13, Morale::Good,    Luck::Neutral,  250,  312, {  240, 0, 0, 0, 0 }, "Flying. Casts Dispel to benefical spells per attack. Casts Advanced Weakness per attack.");
    ...
    static const Creature Wyvern (              CreatureType::Wyvern,              Faction::Fortress,   6, Creature::Upgrade_level::None,    2, true,  14, 14,  0, 14, 18,  70,  7, Morale::Good,    Luck::Neutral, 1050, 1350, {  800, 0, 0, 0, 0 }, "Flying.");
    static const Creature Wyvern_Monarch (      CreatureType::Wyvern_Monarch,      Faction::Fortress,   6, Creature::Upgrade_level::First,   2, true,  14, 14,  0, 18, 22,  70, 11, Morale::Good,    Luck::Neutral, 1518, 1518, { 1100, 0, 0, 0, 0 }, "Flying. 30% chance to cast Poison per attack.");
    ...
    // Conflux
    static const Creature Pixie (               CreatureType::Pixie,               Faction::Conflux,    1, Creature::Upgrade_level::None,   20, false,  2,  2,  0,  1,  2,   3,  7, Morale::Good,    Luck::Neutral,   40,   55, {   25, 0, 0, 0, 0 }, "Flying.");
    static const Creature Sprite (              CreatureType::Sprite,              Faction::Conflux,    1, Creature::Upgrade_level::First,  20, false,  2,  2,  0,  1,  3,   3,  9, Morale::Good,    Luck::Neutral,   70,   95, {   30, 0, 0, 0, 0 }, "Flying. No enemy retaliation.");
    ...
    static const Creature Energy_Elemental (    CreatureType::Energy_Elemental,    Faction::Conflux,    4, Creature::Upgrade_level::First,   5, false, 12,  8,  0,  4,  6,  35,  8, Morale::Good,    Luck::Neutral,  360,  470, {  400, 0, 0, 0, 0 }, "Flying. Non-living. Immune to fire spells (Magic Arrow included). Vulnerable to Ice Bolt and Frost Ring. Spellcaster (Protection from Fire).");
    ...
    static const Creature Stormbird (           CreatureType::Stormbird,           Faction::Cove,       4, Creature::Upgrade_level::None,    4, true,  10,  8,  0,  6,  9,  30,  9, Morale::Good,    Luck::Neutral,  386,  502, {  275, 0, 0, 0, 0 }, "Flying.");
    static const Creature Ayssid (              CreatureType::Ayssid,              Faction::Cove,       4, Creature::Upgrade_level::First,   4, true,  11,  8,  0,  6, 10,  30, 11, Morale::Good,    Luck::Neutral,  478,  645, {  325, 0, 0, 0, 0 }, "Flying. Ferocity.");
    ...
    static const Creature Fangarm (             CreatureType::Fangarm,             Faction::Neutral,    5, Creature::Upgrade_level::None,    3, false, 12, 12,  0,  8, 12,  50,  6, Morale::Good,    Luck::Neutral,  929,  929, {  600, 0, 0, 0, 0 }, "Flying. Immune to mind spells. Unlimited retaliations. Can cast Hypnotize per attack.");
    ...
    static const Creature Faerie_Dragon (       CreatureType::Faerie_Dragon,       Faction::Neutral,    7, Creature::Upgrade_level::None,    1, true,  20, 20,  0, 20, 30, 500, 15, Morale::Good,    Luck::Neutral,16317,30501, {10000, 0, 0, 0, 8 }, "Flying. Spellcaster. Naturally has Magic Mirror.");
    static const Creature Rust_Dragon (         CreatureType::Rust_Dragon,         Faction::Neutral,    7, Creature::Upgrade_level::None,    1, true,  30, 30,  0, 50, 50, 750, 17, Morale::Good,    Luck::Neutral,24030,26433, {15000, 0,14, 0, 0 }, "Flying. Breath attack. Casts Weakness per attack. 20% chance to cast Acid Breath per attack.");
    static const Creature Crystal_Dragon (      CreatureType::Crystal_Dragon,      Faction::Neutral,    7, Creature::Upgrade_level::None,    1, true,  40, 40,  0, 60, 75, 800, 16, Morale::Good,    Luck::Neutral,30260,39338, {20000, 0, 0,10, 0 }, "Flying. Generates crystals. Magic resistance 20%.");
    static const Creature Azure_Dragon (        CreatureType::Azure_Dragon,        Faction::Neutral,    7, Creature::Upgrade_level::None,    1, true,  50, 50,  0, 70, 80,1000, 19, Morale::Good,    Luck::Neutral,56315,78845, {30000,20, 0, 0, 0 }, "Flying. Breath attack. 20% chance to cast Fear to adjacent enemies before they act. Immune to spells level 1-3. Immune to Fear.");
